...
// persona.innerHTML = `
// <h1>Nombre: ${primeraPersona.nombre}</h1>
// <img src="${primeraPersona.imagen}">
// <p>${primeraPersona.edad}</p>
// <p>${primeraPersona.email}</p>
// <p>${primeraPersona.direccion}</p>
// <p>${primeraPersona.colorOjos}</p>
// `
// persona.style.backgroundColor = primeraPersona.colorOjos

// Pedimos un número al usuario

// let indiceUsuario = Number(prompt(`Introduzca un numero del 0 al 6`))

// if(indiceUsuario >= 0 && indiceUsuario < personasLimpias.length) {
//     let personaElegida = personasLimpias[indiceUsuario]
//     persona.innerHTML = `
//     <h1>Nombre: ${personaElegida.nombre}</h1>
//     <img src="${personaElegida.imagen}">
//     <p>Edad: ${personaElegida.edad}</p>
//     <p>Email: ${personaElegida.email}</p>
//     <p>Direccion: ${personaElegida.direccion}</p>
//     <p>Color de ojos: ${personaElegida.colorOjos}</p>
//     `
//     persona.style.backgroundColor = personaElegida.colorOjos
// } else {
//     persona.innerHTML = `
//     Índice no válido`
// }
